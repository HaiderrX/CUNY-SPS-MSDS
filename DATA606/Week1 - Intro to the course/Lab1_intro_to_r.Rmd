...
Upon first glance, there seems to be fluctuations as there are major declines or increases.
However as the years go by, there are major increases, particularly between 1660 and 1680 where the noticeable increase is at.
After 1680, the data seems to be only increasing rather than seeing a major decline similar to 1640 to 1660.
As mentioned, the trend only seems to be increasing or is maintained at around 7000 girls at the end, and possibly would go higher with future data present.
...
This line plot shows no trend of increase or decrease as it "zig-zags" up and down showing no clarity of more boys or less.
What can be noted however is that the boys ratio remains between 0.50 and 0.54.
There is a noticeable peak around the year 1660 where the most boys were born and then the lowest being a little after 1700.
...
-    The years are between 1940 to 2002

-   The dimensions are 63 x 3, 63 rows and 3 columns

-   The column names are similar to that of Arbuthnot's, 'year', 'boys', 'girls'

1.  How do these counts compare to Arbuthnot's? Are they of a similar magnitude?

**Insert your answer here**

These counts are substantially higher than the Arbuthnot counts.
To give an example, in the year 1629, there were 5218 and 4683 boys and girls respectively, but in the present count, there are 1211684 and 1148715 boys and girls.
...
The line plot indicates a downward trend in boys overtime from the year 1940 to 2002.
Arbuthnot's observation about boys being born in greater proportion than girls is incorrect as there is a decline in the boys ratio, however in this visualization the ratio still remains around 0.512 which is slightly higher than the previous Arbuthnot's line plot for boys ratio.
But the fact that it is still declining does not change the fact that the line plot is declining rather than maintaining at a certain ratio or increasing.
...
The most total number of births, 4268326, is in the year 1961.
