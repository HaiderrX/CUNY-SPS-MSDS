...
```{r create-table}
dbExecute(connection, "DROP TABLE IF EXISTS movie_ratings;")
...
```{r using-sql-query}
all_cols <- dbGetQuery(connection, "SELECT * FROM movie_ratings")
all_cols
```
...
[**Video Explainer Link**](https://www.loom.com/share/383a58f61527498a8902b15c06ea6080)
